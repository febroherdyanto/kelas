            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Selamat Datang di Sistem Informasi Kelas TI.20.B.1</h3>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><i class="fa fa-code"></i> <a href="https://febroherdyanto.id" style="color: white; font-weight: bold;">BPH TI.20.B.1</a></p>
                      <p>Made with &#9829;</p>
                    </div>
                  </div>
                </div>

                            ...
                            <table class="table table-striped table-bordered" id="tabelku">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                            $cekmhs = mysqli_query($xkon, "select nim, nama_lengkap from mahasiswa where id_mhs=$id_mhs order by nama_lengkap ASC");
                                        ...
                                        <td style="text-align: center;">
                                            <?php if($row['k_11'] == 'Y'){ ?>
                                                <input type="radio" name="k_11" value="Y" checked> Y &#10003<br>
